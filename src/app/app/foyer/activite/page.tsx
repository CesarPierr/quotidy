  ...
  return (
    <section className="space-y-3 sm:space-y-4">
      <div className="app-surface glow-card rounded-[1.4rem] p-4 sm:rounded-[1.6rem] sm:p-5">
        ...
        <h2 className="display-title mt-1 text-2xl leading-tight sm:text-3xl">Ce qui a bougé récemment</h2>
        ...
        <div className="mt-4 summary-strip grid-cols-2 sm:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h3 className="display-title text-lg leading-tight sm:text-xl">Tâches passées</h3>
              </div>
            </div>
          ...
          <CollapsibleList
            ...
            items={pastOccurrences.map((occ) => {
              ...
              return (
                <article
                  key={occ.id}
                  className="flex items-center gap-3 rounded-xl border border-line bg-white/70 dark:bg-surface/70 p-3"
                >
                  <span
      ...
      <div className="space-y-3 sm:space-y-4">
        {todayLogs.length ? (
          <section className="app-surface deferred-section rounded-[1.4rem] p-4 sm:rounded-[1.6rem] sm:p-5">
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                <span className="flex size-9 items-center justify-center rounded-xl bg-leaf-500/10 text-leaf-600">
                  <CheckCircle2 className="size-4.5" />
                </span>
                <div>
                  <p className="section-kicker">Aujourd&apos;hui</p>
                  <h3 className="display-title text-lg sm:text-xl">À l&apos;instant</h3>
                </div>
              </div>
            ...
            <div className="mt-4 space-y-2">
              {todayLogs.map((log) => {
                ...
                return (
                  <article key={log.id} className="app-surface flex items-center gap-3 rounded-xl border border-line p-3 transition-all hover:bg-white/50 dark:bg-surface/50">
                    <div
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center justify-between gap-2">
                        <h3 className="truncate text-sm font-semibold text-ink-950">{log.occurrence.taskTemplate.title}</h3>
            ...
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h3 className="display-title text-lg sm:text-xl">Activité récente</h3>
                </div>
              </div>
              <span className="accent-pill">
        ...
        {!feedLogs.length && (
          <div className="app-surface rounded-[1.4rem] p-4 text-sm leading-6 text-ink-700 sm:rounded-[1.6rem] sm:p-5">
